...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if not user_id:
        message.reply_text("Sorry Sir, I'm unknown to that person.")
        return ""
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'creator':
        message.reply_text("This person is an admin i can't do that to him.")
        return ""
    ...
    try:
        ...
        message.reply_text("Aye, demoted!")
        return "<b>{}:</b>" \
               "\n#DEMOTED" \
               "\n<b>Admin:</b> {}" \
               "\n<b>User:</b> {}".format(html.escape(chat.title),
